package com.bluescope.exception;
...
public class MyGlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> getUserException(UserException sE, WebRequest wR) {
	...
	public ResponseEntity<ErrorDetails> getPostException(PostException sE, WebRequest wR) {
